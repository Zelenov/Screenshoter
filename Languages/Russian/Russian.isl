...
SetupWindowTitle=Установка — «Скриншотер»
UninstallAppTitle=Удаление
UninstallAppFullTitle=Удаление— «Скриншотер»
...
SelectLanguageLabel=Выберите язык приложения:
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует Мастер установки «Скриншотера»
WelcomeLabel2=Программа установит «Скриншотер» [name/ver] на ваш компьютер.
...
SelectDirDesc=В какую папку вы хотите установить «Скриншотер»?
SelectDirLabel3=Программа установит «Скриншотер» в следующую папку.
...
SelectTasksLabel2=Выберите дополнительные задачи, которые должны выполниться при установке «Скриншотера», после этого нажмите «Далее»:
...
ReadyLabel1=Программа установки готова начать установку «Скриншотера» на ваш компьютер.
...
PreparingDesc=Программа установки подготавливается к установке «Скриншотера» на ваш компьютер.
PreviousInstallNotCompleted=Установка или удаление предыдущей программы не были завершены. Вам потребуется перезагрузить компьютер, чтобы завершить ту установку.%n%nПосле перезагрузки запустите вновь Программу установки, чтобы завершить установку «Скриншотера».
...
InstallingLabel=Пожалуйста, подождите, пока «Скриншотер» установится на ваш компьютер.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение Мастера установки «Скриншотера»
FinishedLabelNoIcons=Программа «Скриншотер» установлена на ваш компьютер.
FinishedLabel=Программа «Скриншотер» установлена на ваш компьютер. Приложение можно запустить с помощью соответствующего значка.
ClickFinish=Нажмите «Завершить», чтобы выйти из программы установки.
FinishedRestartLabel=Для завершения установки «Скриншотера» требуется перезагрузить компьютер. Произвести перезагрузку сейчас?
FinishedRestartMessage=Для завершения установки «Скриншотера» требуется перезагрузить компьютер.%n%nПроизвести перезагрузку сейчас?
...
ConfirmUninstall=Вы действительно хотите удалить «Скриншотер» и все компоненты программы?
...
UninstalledAll=Программа «Скриншотер» была полностью удалена с вашего компьютера.
UninstalledMost=Деинсталляция «Скриншотера» завершена.%n%nЧасть элементов не удалось удалить. Вы можете удалить их самостоятельно.
...
StatusUninstalling=Удаление «Скриншотера»...


; *** Shutdown block reasons
ShutdownBlockReasonInstallingApp=Установка «Скриншотера».
ShutdownBlockReasonUninstallingApp=Деинсталляция «Скриншотера».

; The custom messages below aren't used by Setup itself, but if you make
; use of them in your scripts, you'll want to translate them.

[CustomMessages]
MyAppName=Скриншотер 
MyAppVerName=Скриншотер %1
LanguageNumber =1
...
ProgramOnTheWeb=Сайт «Скриншотера» в Интернете
UninstallProgram=Удалить «Скриншотер»
LaunchProgram=Запустить «Скриншотер»
...
AutoStartProgram=Автоматически запускать «Скриншотер»
